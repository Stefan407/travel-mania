...
$list = [];
getAllResults("https://experience.tripster.ru/api/cities/?country__name_en=Russia", $list);
?>
...
<body class="home blog custom-background hfeed has-header-image has-sidebar">
    <div id="header">
        ...
        <div class="menu-wrapper">
            <div class="container">
                <div class="menu-wrap">
                    <div class="menu-logo"><a href="https://travel-mania.org/"><img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/logo.png" alt=""></a></div>
                        ...
                        <div class="search-block">
                            <div class="search-item">
                                <div class="input-search_wrap"> <input placeholder="Куда вы едете?" type="text" id="searchInput" class="search-input">
                                    <div class="windows8" style="display: none;"> <img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/2.gif" alt=""></div>
                                    <div class="search-icon-des"> <img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/search-icon-white.svg" alt=""></div>
                                </div>
                    ...
                    <div class="burger"><img class="burger-btn" src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/burger-icon.png" alt=""></div>
                    <div class="search-icon"><img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/search-icon.svg" alt=""></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="top">
        <div class="top__slider">
            <div id="top-images" class="image-top_slider"> <img src="/wp-content/uploads/France/France-1-min.jpg" alt=""></div>
        ...
        <div class="breadcrumbs" itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList">
            <div class="container breadcrumbs-wrap">
                <div class="breadcrumbs-item" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                    <div class="breadcrumbs__block"> <a class="breadcrumbs__link" href="https://travel-mania.org" itemprop="item"> <span itemprop="name">Главная</span>
                            <meta itemprop="position" content="1"> </a></div>
                    <div class="breadcrumbs__arrow"> <img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/arrow-bread.png" alt=""></div>
                </div>
                <div class="breadcrumbs-item" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                    <div class="breadcrumbs__block">
                        <p class="breadcrumbs__text"> <span itemprop="name">Франция</span>
    ...
    <footer class="footer-site">
        <div class="container"> <img src="https://travel-mania.org/wp-content/themes/lz-computer-repair/assets/images/logo.png" alt="" class="f-logos">
            <nav class="f-menu">
