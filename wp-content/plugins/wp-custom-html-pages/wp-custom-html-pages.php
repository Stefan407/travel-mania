 ...
 * Plugin URI: https://witserbia.com/wordpress-plugins/wp-custom-html-pages/
...
function WPCHTMLP_install_data() {
    ...
    $example_html = '<!DOCTYPE html><html><head><title>WP Custom HTML Pages plugin example page</title></head><body style="text-align:center;"><h1>Welcome to the example page of WP Custom HTML Pages plugin</h1><br><br><a href="https://witserbia.com/wordpress-plugins/wp-custom-html-page/">Plugin link</a></body></html>';
...
function WPCHTMLP_permalink_handler() {
    ...
    if($query_uri[0]=="/")  $query_uri = substr($query_uri, 1);
...
function WPCHTMLP_menu_options() {
    ...
    echo '<p>To report plugin problems or submit feature requests <a href="https://witserbia.com/wordpress-plugins/wp-custom-html-pages/" target="_blank">go here</a>.</p>';
    ...
    echo '<table class="form-table">
        ...
        <td><input type="checkbox" name="wpchtmlp_opt_filter_params" id="wpchtmlp_opt_filter_params" value="1" '.checked(get_option('wpchtmlp_opt_filter_params'),1).' />
        ...
        <td>
        <input type="radio" name="wpchtmlp_opt_editor_type" value="1" '.checked(1, get_option('wpchtmlp_opt_editor_type'), true).'>ACE Editor&nbsp;&nbsp;
        <input type="radio" name="wpchtmlp_opt_editor_type" value="2" '.checked(2, get_option('wpchtmlp_opt_editor_type'), true).'>Textarea&nbsp;&nbsp;
        ...
        <td><input type="checkbox" name="wpchtmlp_opt_allow_wp-admin" id="wpchtmlp_opt_allow_wp-admin" value="1" '.checked(get_option('wpchtmlp_opt_allow_wp-admin'),1).' />
        ...
        <td><input type="checkbox" name="wpchtmlp_opt_remove_table_on_uninstall" id="wpchtmlp_opt_remove_table_on_uninstall" value="1" '.checked(get_option('wpchtmlp_opt_remove_table_on_uninstall'),1).' />
