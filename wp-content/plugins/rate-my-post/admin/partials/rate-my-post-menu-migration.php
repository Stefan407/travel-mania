...
<div class="rmp-migration rmp-tabcontent" id="rmp-tab-4">
  ...
  <p class="rmp-tip">
    <i>*<?php echo ( esc_html__( 'The plugin allows you to easily migrate ratings from the following plugins: kk Star Ratings, WP-PostRatings and Yasr. More rating plugins will be supported in the future. Here you can submit requests', 'rate-my-post' ) ); ?>: <a href="https://wordpress.org/support/plugin/rate-my-post/" target="_blank">Support Forum</a> </i>
  </p>
  <h3>
