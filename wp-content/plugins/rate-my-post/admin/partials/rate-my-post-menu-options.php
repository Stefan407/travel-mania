...
<div class="rmp-options rmp-tabcontent rmp-tabcontent-current" id="rmp-tab-1">
  ...
  <div class="rmp-option-group">
    ...
    <select id="rmp-icon-type">
      <option value="1" <?php echo ($rmp_options['icon_type'] === 1) ? 'selected="selected"':""; ?>>Stars</option>
      <option value="2" <?php echo ($rmp_options['icon_type'] === 2) ? 'selected="selected"':""; ?>>Thumbs</option>
      <option value="3" <?php echo ($rmp_options['icon_type'] === 3) ? 'selected="selected"':""; ?>>Hearts</option>
      <option value="4" <?php echo ($rmp_options['icon_type'] === 4) ? 'selected="selected"':""; ?>>Smileys</option>
      <option value="5" <?php echo ($rmp_options['icon_type'] === 5) ? 'selected="selected"':""; ?>>Trophies</option>
    </select>
    <p class="rmp-notice">
  ...
  <div class="rmp-option-group">
    ...
    <select id="widget-align">
      <option value="1" <?php echo ($rmp_options['widgetAlign'] === 1) ? 'selected="selected"':""; ?>>Center</option>
      <option value="2" <?php echo ($rmp_options['widgetAlign'] === 2) ? 'selected="selected"':""; ?>>Left</option>
      <option value="3" <?php echo ($rmp_options['widgetAlign'] === 3) ? 'selected="selected"':""; ?>>Right</option>
    </select>
    <p class="rmp-notice">
      ...
      <tr>
        ...
        <td>
          <div class="rmp-option-group">
            ...
            <p class="rmp-notice">
              <?php echo ( esc_html__( 'On touch devices vote has to be confirmed by clicking the rate button', 'rate-my-post' ) ); ?>.
            </p>
          </div>
        </td>
      </tr>
      ...
      <td>
        <div class="rmp-option-group">
          ...
          <p class="rmp-notice">
            ...
            <a href="https://wordpress.org/support/plugin/rate-my-post/" target="_blank">support forum</a>
