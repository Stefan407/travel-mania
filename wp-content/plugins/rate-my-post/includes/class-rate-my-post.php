...
class Rate_My_Post {
	...
	private function define_admin_hooks() {
		...
		//META BOX
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'manipulate_rating_meta_box' );
		//UPDATE RESULTS AJAX
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'the_content', $plugin_public, 'rating_widget_every_post_page' );
		//INCLUDE RESULT WIDGET AUTOMATICALLY - FILTER CONTENT
		$this->loader->add_filter( 'the_content', $plugin_public, 'result_widget_every_post_page' );
		...
		//DISABLE FONTAWESOME TRANSLATE
		$this->loader->add_action( 'admin_head', $plugin_public, 'disable_fontawesome_translate' );
		//DISABLE FONTAWESOME TRANSLATE
		$this->loader->add_action( 'wp_head', $plugin_public, 'disable_fontawesome_translate' );
