        ...
        <div class="f-bottom">
            <div class="f-social" style="display: flex;align-items: center;width: 100%;flex-direction: column-reverse;">
                ...
                <div style="display:flex; align-items:center; margin-bottom:10px">
                    ...
                    <a style="padding: 0 5px" href="/go/?url=https://travel-mania-org.tumblr.com/" target="_blank"><img src="/wp-content/themes/lz-computer-repair/assets/images/icon-tumblr.jpg"></a>
                </div>
            </div>
        </div>
    </div>
