...
<footer class="footer-site">
    <div class="container">
        <img src="<?= home_url() ?>/wp-content/themes/lz-computer-repair/assets/images/pay-icon.png" alt="" class="f-logos">
        <nav class="f-menu">
        ...
        <div class="f-bottom">
            <div class="f-social">
                <a href="https://www.facebook.com/" class="f-social__link f-social__link_fb" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" id="fb" viewBox="0 0 430.113 430.114">
                        <path d="M158.081,83.3c0,10.839,0,59.218,0,59.218h-43.385v72.412h43.385v215.183h89.122V214.936h59.805       c0,0,5.601-34.721,8.316-72.685c-7.784,0-67.784,0-67.784,0s0-42.127,0-49.511c0-7.4,9.717-17.354,19.321-17.354       c9.586,0,29.818,0,48.557,0c0-9.859,0-43.924,0-75.385c-25.016,0-53.476,0-66.021,0C155.878-0.004,158.081,72.48,158.081,83.3z"></path>
                    </svg>
                </a>
                <a href="https://vk.com/" class="f-social__link f-social__link_vk" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" id="vk" viewBox="0 0 548.358 548.358">
                ...
                <a href="https://www.instagram.com" class="f-social__link f-social__link_ig" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" id="insta" viewBox="0 0 512 512">
