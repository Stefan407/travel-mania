        ...
        <div class="container">
            <div class="wrap">
                ...
                <div class="about-faq-block" style="display: block;">
                    ...
                    Если поездка сорвалась и Вы не сможете посетить экскурсию — Вам нужно заранее предупредите гида (это обязательно!), после этого напишите в службу поддержки поставщика. Вам вернут деньги в соответствии с политикой возврата.                </div>
                <div class="about-faq-block" style="display: block;">
