    ...
    <section class="top">
            ...
            <div class="top__slider-text">
                <div class="container">
                    <div class="top__content-text">
                        <h1>Онлайн-экскурсии <?php echo ($list[0]->city->in_obj_phrase) ?></h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="breadcrumbs" itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList">
            <div class="container breadcrumbs-wrap">
                ...
                <div class="breadcrumbs-item" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                    <div class="breadcrumbs__block">
                        <a class="breadcrumbs__link" href="/online-excursions/">
                ...
                <div class="breadcrumbs-item" style="display: none;" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                    <div class="breadcrumbs__block">
                        <meta itemprop="item" content="https://travel-mania.org/online-excursions/<?php echo ($city__name_online) ?>/">
                        <p class="breadcrumbs__text">
                            <span itemprop="name">Онлайн экскурсии <?php echo ($list[0]->city->in_obj_phrase) ?></span>
                        </p>
                        <meta itemprop="position" content="2">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="border-box js-container-tags">
                <h2>Онлайн-экскурсии и вебинары <?php echo ($list[0]->city->in_obj_phrase) ?></h2>
                <div class="border-box__text">
                    <p>Онлайн-экскурсии <?php echo ($list[0]->city->in_obj_phrase) ?> проходят в виде «живой» трансляции, которую проводит гид гуляя по достопримечательностям и улицам города. Вебинары – это прогулки по городу в Google Street View с презентациями и комментариями гида.</p>
                </div>
                <section class="list-tags">
                    <div class="container">
                        <div class="list-tags-wrap">
                            <a class="all link" href="/online-excursions/">
                                <span>Все</span>
                            </a>
                ...
                <section class="list-tags js-list-tags">
                    <div class="container">
                        <div class="list-tags-wrap">
                            <a class="all open-link-def link" data-link="/online-excursions">
                                <span>Все</span>
                            </a>
                            <?php foreach ($onlineCitiesResult as $item) {
                            ...
                            <div class="tours__item-content ">
                                ...
                                <div class="item-price-guide">
                                    <div class="item-guide">
                                        ...
                                        <div class="item-guide-name"><?php echo $item->guide->first_name ?></div>
                                    </div>
