                    ...
                    <div class="main_content-description">
                        <div class="description-item">
                            ...
                            <div class="order-panel-wrap">
                                ...
                                <span class="order-item">
                                    <div class="order-item-string"><img src="/assets/images/lightning.svg"> Быстрое бранирование </div>
                                    <div class="order-item-string"><img src="/assets/images/warranty-icon.svg"> Гарантия лучшей цены </div>
                                    <div>
                        ...
                        <?php if ($reviews->results) { ?>
                            ...
                            <div class="reviews-btn">
                                <span onclick="ym(56569540,'reachGoal','vse-otzivi'); more()">⇓ показать все отзывы ⇓</span>
                            </div>
