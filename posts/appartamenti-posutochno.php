...
<script>
  ...
  gtag('config', 'G-YL417K3EGK');
    ...
    <title>Апартаменты и квартиры посуточно • Travel Mania</title>
    <meta name="keywords" content="апартаменты, квартиры, аренда, снять, посуточно, россия, москва, петербург, сочи, казань, травел, мания" />
    <meta name="description" content="🟢 Крупнейший и экономный сервис бронирования квартир, апартаментов и котеджей по все России и не только. Более 500 городов и 75 000 вариантов. Удобное онлайн бронирование и гарантия заселения!" />
    <?php
    ...
    <section class="top">
        ...
        <div class="breadcrumbs" style="display: none;" itemscope="itemscope" itemtype="http://schema.org/BreadcrumbList">
            <div class="container breadcrumbs-wrap container-post">
                ...
                <div class="breadcrumbs-item"  style="display: none;" itemprop="itemListElement" itemscope="itemscope" itemtype="http://schema.org/ListItem">
                    <div class="breadcrumbs__block">
                        <meta itemprop="item" content="/blog/post-appartamenti-posutochno/">
                        <p class="breadcrumbs__text">
                            <span itemprop="name">Аренда квартир и апартаментов в России</span>
                        </p>
