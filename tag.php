...
$page_title =  "" . $currentTag->header . $textRu . " 2021 🥇 цены, отзывы, описание • Travel Mania";
...
<script>
  ...
  gtag('config', 'G-YL417K3EGK');
    ...
    <meta name="keywords" content="экскурсии, <?php echo ($tag_list[0]->city->in_obj_phrase); ?>, <?php echo ($currentTag->name); ?>, русский, на русском, гиды, авторские, эксклюзивные, исторические, обзорные, пешеходные, на автобусе, купить, заказать, забронировать, цена, недорого, дешево, скидка, описание, список, прайс, 2021, травэл, мания, travel, mania" />
    <meta name="description" content="🟢 <?php echo ($currentTag->header); ?> с интересными и харизматичными гидами. Быстрое бронирование всех экскурсий по актуальным ценам 2021 года. Перед заказом любой экскурсии можно задать вопрос гиду на сайте. Все экскурсии тщательно продуманы и составлены гидами." />
    <?php
                            ...
                            <?php foreach ($listTagsNew as $item) : ?>
                                <?php if ($item->is_hidden == false and $item->experience_count > 0) : ?>
                                    <?php if ($item->slug == "all") { ?>
                                        <a class="all link" href="/<?php echo ($country_new_en); ?>/<?php echo ($city_name); ?>/">
                                            <span>Все</span><span style="margin-left: 5px;margin-top: 2px;"><?php echo ($item->experience_count); ?></span>
                                        </a>
                                    <?php } else if ($tag_id == $item->id) { ?>
                                        <a class="active link" href="/<?php echo ($country_new_en); ?>/<?php echo ($city_name); ?>/excursions-<?php echo ($item->slug); ?>-<?php echo $tag_list[0]->city->id; ?>-<?php echo ($item->id); ?>/">
                                            <span><?php echo ($item->name); ?></span><span style="margin-left: 5px;    margin-top: 2px;"><?php echo ($item->experience_count); ?></span>
                                        </a>
                                    <?php } else { ?>
                                        <a class="link" href="/<?php echo ($country_new_en); ?>/<?php echo ($city_name); ?>/excursions-<?php echo ($item->slug); ?>-<?php echo $tag_list[0]->city->id; ?>-<?php echo ($item->id); ?>/">
                                            <span><?php echo ($item->name); ?></span><span style="margin-left: 5px;    margin-top: 2px;"><?php echo ($item->experience_count); ?></span>
                                        </a>
                                    <?php } ?>
                                <?php endif; ?>
                    ...
                    <div class="container">
                        <div class="list-tags-wrap">
                            <?php foreach ($listTagsNew as $item) : ?>
                                <?php if ($item->is_hidden == false and $item->experience_count > 0) : ?>
                                    <?php if ($item->slug == "all") { ?>
                                        <div class="link all open-link-def" data-link="https://travel-mania.org/<?php echo ($country_new_en); ?>/<?php echo ($city_name); ?>/">
                                            <span>Все</span><span style="margin-left: 5px;margin-top: 2px;"><?php echo ($item->experience_count); ?></span>
                                        </div>
                                    <?php } else if ($tag_id == $item->id) { ?>
                                    ...
                                    <?php } else { ?>
                                        <div class="open-link-def link" data-link="https://travel-mania.org/<?php echo ($country_new_en); ?>/<?php echo ($city_name); ?>/excursions-<?php echo ($item->slug); ?>-<?php echo $tag_list[0]->city->id; ?>-<?php echo ($item->id); ?>/">
                                            <span><?php echo ($item->name); ?></span><span style="margin-left: 5px;    margin-top: 2px;"><?php echo ($item->experience_count); ?></span>
                                        </div>
                                    <?php } ?>
                                <?php endif; ?>
    ...
    <section class="video">
        <div class="container">
            <div class="border-box">
                ...
                <div class="video-box">
                    <div>
                        <p><?php echo ($currentTag->header); ?> можно забронировать посмотрев наш видеопример. Перед тем, как Вы определитесь с экскурсией и выберете удобную дату, можно задать любой вопрос гиду. Посмотрите видео и узнайте все преимущества.</p>
