...
<body>
    ...
    <section class="top">
        ...
        <div class="container">
            <div class="border-box">
                <h2>Экскурсии <?php echo ($tag_list[0]->city->in_obj_phrase);
                                echo ($textRu); ?></h2>
                <div id="top-text-city" class="border-box__text">
                    <?php if ($current_des_city->textTop != "") : ?>
                        <?php echo $current_des_city->textTop; ?>
                        <?php else : ?>Travel Mania предлагает авторские экскурсии <?php echo ($tag_list[0]->city->in_obj_phrase); ?> на русском языке. Каждый желающий может подобрать подходящую экскурсию, как групповую, так и индивидуальную и забронировать на удобную дату.
                    <?php endif; ?>
                </div>
    ...
    <section class="video">
        <div class="container">
            <div class="border-box">
                <h2>Главные экскурсионные места <?php echo ($tag_list[0]->city->in_obj_phrase); ?></h2>
                <div class="video-box">
                    <div id="video-text-city" class="video__text">
                        <?php if ($current_des_city->textButton != "") {
                            echo ($current_des_city->textButton);
                        } else { ?>
                            В ближайшие время мы подготовим детальное описание главных экскурсионных маршрутов <?php echo ($tag_list[0]->city->in_obj_phrase); ?>.
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="video-box">
                    <div>
                        <p>Забронировать экскурсии <?php echo ($tag_list[0]->city->in_obj_phrase); ?> поможет наш видиопример. Перед тем, как Вы определитесь с тематикой экскурсии и выбирите удобную дату, можно задать любой вопрос гиду. Посмотрите видео и узнайте все наши приемущества.</p>
